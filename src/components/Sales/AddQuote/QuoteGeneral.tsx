...
const QuoteGeneral: React.FC<QuoteGeneralProps> = ({ quote, setQuote }) => {
  ...
  const validateAndSetQuote = (field: keyof Quote, value: string | boolean) => {
    ...
    let error = '';
    const tempQuote = { ...quote, [field]: sanitizedValue };
    ...
    <fieldset className="form-section">
      ...
      <div className="form-grid" style={{ display: 'grid', gap: '1rem', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))' }}>
        ...
        <div className="form-group" style={{ flex: '1 1 45%' }}>
          ...
          <select
            id="quote_customer"
            value={quote.quote_customer || ''}
            onChange={(e) => validateAndSetQuote('quote_customer', e.target.value)}
            onBlur={() => validateAndSetQuote('quote_customer', quote.quote_customer || '')}
          >
        ...
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <select
            ...
            onBlur={() => validateAndSetQuote('quote_cust_ref_no', quote.quote_cust_ref_no || '')}
          >
            <option value="" disabled>
              ...
              {type === 'boolean' ? (
                <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
                  <input
                    type="checkbox"
                    id={key}
                    checked={!!quote[key as keyof Quote]}
                ...
                <div className="form-group" style={{ flex: '1 1 45%' }}>
                  ...
                  <input
                    ...
                    value={String(quote[key as keyof Quote] || '')}
